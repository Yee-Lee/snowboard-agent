...
Date: 2026-08-22  
Status: `DRAFT / NOT FOR CITATION / COMPLETE LABEL AUDIT PENDING`
...
audio/reference pairs must be audited before publication.
...
After the label audit closes, an accurate statement may describe these exact
