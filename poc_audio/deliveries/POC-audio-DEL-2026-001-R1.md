...
runtime evidence is bound to Audio SHAs
`8be3bc095b504b8eab1dfeb21b94173728b9656f` and
`26f33a3c371eee61df46924432839d0fa9ee3bf8`, and Core HAL SHA
`6c7fc8ce94c7218e4948b77c2fe79ef6e6cc3dcf`.

The authoritative report and machine-readable summary are:
...
P9.1, independent 20-session combined execution, offline operation and all 12
failure/recovery cases technically pass. Models, raw results, private audio,
