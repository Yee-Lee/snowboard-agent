...
- **Branch**: `llm`
- **POC exact SHA**: `0b5a92872f8a695b145b389168111420cd2592c5`
- **Date**: 2026-08-20
- **Status**: `SUBMITTED FOR CORE REVIEW / REAL EXECUTION NOT AUTHORIZED`
...
Core review must use POC branch `llm` at exact SHA
`0b5a92872f8a695b145b389168111420cd2592c5`; branch HEAD or later commits are not substitutes.
