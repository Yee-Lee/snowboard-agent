...
| :--- | :--- | :--- | :--- | :--- |
| [`PM-OUT-260830-025-hw-diagnostic-tool`](history/PM-OUT-260830-025-hw-diagnostic-tool.md) | Hardware Diagnostic Tool | 無 | **Resolved** | Automated: `scripts/hw_diag.py`；manual button: `scripts/run_button.py`；regression: `tests/test_pm_025_hw_diag.py` |
