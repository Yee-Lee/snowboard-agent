...
| --- | --- | --- |
| [DELIVERY-AUDIO-POC-M4A-M2AB-SCOPE-ACK-003](DELIVERY-AUDIO-POC-M4A-M2AB-SCOPE-ACK-003.md) | `ACCEPTED / M2A FIXTURE LOCKED` | Rows、official identities、budgets、internal exact 8 與 Common Voice exact 12 PCM 已鎖定且未執行；下一步為逐 row preflight 與 bounded survey。VAD real-engine row 仍未授權。 |
