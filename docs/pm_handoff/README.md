...
| --- | --- | --- |
| [DELIVERY-AUDIO-POC-M4A-M2AB-SCOPE-ACK-003](DELIVERY-AUDIO-POC-M4A-M2AB-SCOPE-ACK-003.md) | `ACCEPTED / M2A SOURCE LOCKED` | Rows、official identities、budgets 與 selector 已準備；internal exact 8 與 Common Voice exact 12 sources 已鎖定，exact fixture lock 只等待 derived PCM。VAD real-engine row 仍未授權。 |
