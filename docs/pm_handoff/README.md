...
| --- | --- | --- |
| [M2 Gate closure request](../../poc_audio/deliveries/REQ-AUDIO-M2-GATE-CLOSURE-001.md) | `READY FOR REVIEW` | WebRTC/Silero bounded scorecard 提出 evidence-backed VAD no-go；exact M3 HAL implementation SHA、topology 與 minimal lifecycle retest packet 已提交。請 Reviewer/Designer 關閉 findings 或只列 exact remaining blocker。 |
| [M2 Gate review request](../../poc_audio/deliveries/REQ-AUDIO-M2-GATE-REVIEW-001.md) | `RESPONSE ACTIONED / CLOSURE REQUESTED` | Reviewer 接受 ASR/TTS 並授權 VAD；其要求的 VAD scorecard 與 M3 entry locks 均已提交至新的 closure request。原 response 見 [`RESP-AUDIO-M2-GATE-REVIEW-001`](../reviews/RESP-AUDIO-M2-GATE-REVIEW-001.md)。 |
...
| [VAD execution scope change request](../../poc_audio/deliveries/CR-AUDIO-M4A-G1B-VAD-SCOPE-001.md) | `EXECUTED / NO-GO RECOMMENDED` | WebRTC 失敗 recall/false-start gates；Silero conditional fallback 失敗 recall gates。兩列 bounded、clean、未 throttle；詳見 [`M2-VAD-BOUNDED-SCORECARD-001`](../../poc_audio/evidence/m2/M2-VAD-BOUNDED-SCORECARD-001.md)。 |
