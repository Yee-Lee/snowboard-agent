...
| M2B ASR optimization | `IN_PROGRESS / C PCM LOCKED` | 首個量化 probe 已 reviewed；C 已分開鎖定 Internal/Common Voice PCM、尚未 inference；其餘 probes、primary/fallback、recipe 與 delta table 未關閉 |
