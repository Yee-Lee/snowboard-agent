...
| M2B Optimization Feasibility | `IN_PROGRESS / BASE Q8 PADDING REVIEWED` | Internal dev+holdout 顯示 P300 與 P0 合併 CER 相同且 category trade-off；base Q8 保留 P0，Common Voice 尚未執行 |
