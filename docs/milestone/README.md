...
| M4 | `IN_PROGRESS / P9.1 SAMPLER CORRECTION` | corrected catalog 的 20 sessions 曾完成，但背景 sampler race 使 evidence 無效；fail-closed 修正及 212-test regression 已完成，下一步以新 SHA 從頭重跑 | [M4](m4_combined_validation_and_delivery.md) |
