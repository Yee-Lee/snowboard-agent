#!/usr/bin/env python3
"""Fail-closed, dependency-free installer for the pinned ARM64 API wheel."""
...
def main() -> int:
    ...
    report = {"installer_id":"G1-ARM64-WHEEL-INSTALLER-001","result":"FAIL"}
    ...
    try:
        ...
        with zipfile.ZipFile(args.wheel) as archive:
            if archive.testzip() is not None:
                raise ValueError("wheel archive integrity failed")
